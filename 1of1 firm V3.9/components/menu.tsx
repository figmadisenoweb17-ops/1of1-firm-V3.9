      ...
      <div className="py-2 sm:py-4 px-3 sm:px-6 space-y-0.5 sm:space-y-1">
        ...
        {viewAllLabel && viewAllPage && (
          <button
            ...
            className="mt-2 sm:mt-4 px-4 sm:px-6 py-1.5 sm:py-2 border border-amber-500/50 text-amber-500 text-[10px] sm:text-xs tracking-widest hover:bg-amber-500 hover:text-black transition-all duration-300 w-full"
          >
            {viewAllLabel}
          </button>
        )}
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="relative h-[50svh] sm:h-[55svh] md:min-h-screen flex flex-col items-center justify-center bg-black">
        ...
        <div className="relative z-10 text-center px-4 flex flex-col items-center justify-center">
          <h1 className="text-2xl sm:text-3xl md:text-9xl font-light tracking-wider">
            <span className="text-white">1</span>
            <span className="text-white/80 text-base sm:text-xl md:text-7xl mx-1 md:mx-4">OF</span>
            <span className="text-white">1</span>
          </h1>
