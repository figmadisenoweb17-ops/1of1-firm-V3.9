...
const products: Product[] = [
  {
    ...
    price: 159000,
    sizes: ["S", "M", "L", "XL"],
    mainImage: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/file_00000000bc8071f7be5c20fa2196f225-oIE8TFo9EldPubCoux9H3GdXw7lVFU.png",
    galleryImages: [
  ...
  return (
    <div className="min-h-screen bg-black">
      ...
      <div className="px-4 md:px-8 py-8 -mt-20 relative z-10">
        ...
        {/* Buy Button */}
        <button className="w-full md:max-w-md py-4 border border-white/30 text-white text-sm tracking-[0.2em] hover:bg-white hover:text-black transition-all duration-300">
          BUY
        </button>
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="px-4 md:px-8 py-16">
        <div className="max-w-6xl mx-auto text-center">
          <div className="border border-white/10 py-16 px-8">
