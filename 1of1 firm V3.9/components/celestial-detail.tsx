...
import { MapPin, Menu as MenuIcon, ArrowLeft } from "lucide-react"
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="relative min-h-screen flex flex-col justify-end pb-12">
        ...
        <div className="relative z-10 px-4 md:px-8 text-center">
          ...
          {/* Title */}
          <h1 className="text-[18px] font-[500] tracking-wider mb-2 text-amber-500/90" style={{ fontFamily: '"Inter", sans-serif' }}>
            MISS 1 OF 1
          </h1>
          <h2 className="text-[18px] font-[500] tracking-wider mb-8 text-amber-500/90" style={{ fontFamily: '"Inter", sans-serif' }}>
            CELESTIAL
          </h2>
