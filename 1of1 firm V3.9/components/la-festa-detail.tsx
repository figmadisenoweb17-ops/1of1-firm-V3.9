...
import { Calendar, MapPin, Clock, Play, Globe, Menu as MenuIcon, ArrowLeft } from "lucide-react"
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="relative min-h-[50vh] sm:min-h-[60vh] md:min-h-[70vh] flex flex-col justify-end pb-4 sm:pb-6 md:pb-8">
        ...
        <div className="relative z-10 px-3 sm:px-4 md:px-8 text-center mt-50">
          <span className="mt-50 block text-amber-500 text-[10px] sm:text-xs tracking-[0.2em] sm:tracking-[0.3em] mb-1 sm:mb-2 block">SIGNATURE EVENTS</span>
